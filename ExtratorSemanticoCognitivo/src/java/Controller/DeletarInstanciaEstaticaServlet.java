 ...
 * @author thiag
 */
@WebServlet(name = "DeletarInstanciaEstaticaServlet", urlPatterns = {"/DeletarInstanciaEstaticaServlet"})
public class DeletarInstanciaEstaticaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            validate = inst.deletarInstanciaEstatica(codigo);
    ...
    public String getServletInfo() {
        return "Servlet responsável por deletar instância estática!";
    }
