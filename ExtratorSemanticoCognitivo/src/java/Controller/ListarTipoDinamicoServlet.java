 ...
 * @author thiag
 */
@WebServlet(name = "ListarTipoDinamicoServlet", urlPatterns = {"/ListarTipoDinamicoServlet"})
public class ListarTipoDinamicoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
         ...
         //*****************LISTAR TIPO DINAMICO*****************
        TipoDinamicoDAO tdao = new TipoDinamicoDAO();
        List<TipoDinamico> te = tdao.ListaTipoDinamico();
        
        JsonResposta j = new JsonResposta();
        String resultado = j.getJsonTipoDinamico(te);
    ...
    public String getServletInfo() {
        return "Servlet responsável por retornar uma lista com Tipos Dinâmicos!";
    }// </editor-fold>
